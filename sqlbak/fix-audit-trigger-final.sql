...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    IF has_action AND has_action_type AND has_table_name AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, TG_TABLE_NAME, NEW.id, record_name_value, to_jsonb(NEW), '創建新記錄');
    ...
    ELSIF has_action AND has_action_type AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, NEW.id, record_name_value, to_jsonb(NEW), '創建新記錄');
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    IF has_action AND has_action_type AND has_table_name AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, TG_TABLE_NAME, NEW.id, record_name_value, to_jsonb(OLD), to_jsonb(NEW), '更新記錄');
    ELSIF has_action AND has_table_name AND has_module THEN
    ...
    ELSIF has_action AND has_action_type AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, NEW.id, record_name_value, to_jsonb(OLD), to_jsonb(NEW), '更新記錄');
    ELSIF has_action AND has_module THEN
  ...
  ELSIF TG_OP = 'DELETE' THEN
    IF has_action AND has_action_type AND has_table_name AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, TG_TABLE_NAME, OLD.id, record_name_value, to_jsonb(OLD), '刪除記錄');
    ELSIF has_action AND has_table_name AND has_module THEN
    ...
    ELSIF has_action AND has_action_type AND has_module THEN
      ...
      VALUES (current_user_id, current_user_name, action_value, action_value, TG_TABLE_NAME, OLD.id, record_name_value, to_jsonb(OLD), '刪除記錄');
    ELSIF has_action AND has_module THEN
